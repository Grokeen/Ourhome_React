                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div className="checkbox-group">
                                            <label>
                                                <input type="radio" name="recentAccident" value="true" /> 예
                                            </label>
                                            <label>
                                                <input type="radio" name="recentAccident" value="false" /> 아니오
                                            </label>
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div className="checkbox-group">
                                            <label>
                                                <input name = "vehicleUsage" type="radio" value="출퇴근" onChange={() => setHasOtherVehicleUsage(false)} /> 출퇴근
                                            </label>
                                            <label>
                                                <input name = "vehicleUsage" type="radio" value="영업용" onChange={() => setHasOtherVehicleUsage(false)}/> 영업용
                                            </label>
                                            <label>
                                                <input name = "vehicleUsage" type="radio" value="개인용" onChange={() => setHasOtherVehicleUsage(false)}/> 개인용
                                            </label>
                                            <label>
                                                    <input type="radio" value="기타"  name = "vehicleUsage" onChange={() => setHasOtherVehicleUsage(true) }
                                                    />{" "}
                                                    기타
                                            </label>
