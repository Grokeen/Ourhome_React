...
function InsFireJoinFinal() {
    ...
    useEffect(() => {
        ...
        const fetchInsuranceData = async () => {
            try {
                const response = await fetch("http://localhost:8080/join/fire/"+id, {
                    method: "GET",
                    headers: {
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th>재산 주소</th>
                                <td>
                                    {insuranceData.propertyAddress}
                                </td>
                            </tr>
                            <tr>
                                <th>상세 주소</th>
                                <td>
                                    {insuranceData.propertyDetailAddress}
                                </td>
                            </tr>
                            <tr>
                                <th>건물 유형</th>
                                <td>
                                    {insuranceData.buildingType}
                                </td>
                            </tr>
                            <tr>
                                <th>건축 년도</th>
                                <td>
                                    {insuranceData.buildingYear}
                                </td>
                            </tr>
                            <tr>
                                <th>은행</th>
...
export default InsFireJoinFinal;
