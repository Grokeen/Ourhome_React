            ...
            <li className="list-prd">
              <Link
                ...
                onClick={(e) => {
                  ...
                  handleNavigation("/request/health");
                }}
              >
                <p className="title">
                  <strong>건강보험청구</strong>
                </p>
                <p className="text">
          ...
          <ul>
            <li className="list-prd">
              <Link
                ...
                onClick={(e) => {
                  e.preventDefault();
                  handleNavigation("/request/fire");
                }}
              >
                <p className="title">
                  <strong>화재보험청구</strong>
                </p>
                <p className="text">
          ...
          <ul>
            <li className="list-prd">
              <Link
                ...
                onClick={(e) => {
                  e.preventDefault();
                  handleNavigation("/request/auto");
                }}
              >
                <p className="title">
                  <strong>자동차보험청구</strong>
                </p>
                <p className="text">
                  <span className="fc-blue">넌 웃을 때가 제일 예뻐</span>
                  <br />
